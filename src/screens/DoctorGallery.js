...
import { View, Text, StyleSheet, Image, FlatList, TouchableHighlight, ActivityIndicator, Modal } from 'react-native';
...
class DoctorGallery extends React.Component {
  ...
  get_gallery() {
    const id_doctor = this.props.navigation.getParam('id_gallery')
  ...
  render() {
    ...
    const name = this.props.navigation.getParam('name_d')
    return (
          ...
          <View style={{ flex: 1, margin: 5, top: 5 }}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => <View style={{ flex: 1, flexDirection: 'column', margin: 1 }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => { this.toggleModal(true, p = item.pic_name) }}
                >
                  <Image
            ...
            <Modal
              ...
              <View style={{
                ...
                <Image
                  resizeMode='contain'
                  style={{ height: hp(30), width: wp(80), borderWidth: 1, borderColor: 'gray', justifyContent: 'center', alignItems: 'center', marginVertical: 25, }}
...
export default connect(mapStateToProps, mapDispatchToProps)(DoctorGallery)
